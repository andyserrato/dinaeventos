...
angular.module('dinaeventos',['ngRoute','ngResource'])
  .config(['$routeProvider', function($routeProvider) {
    $routeProvider
      ...
      .when('/Sexos',{templateUrl:'views/Sexo/search.html',controller:'SearchSexoController'})
      .when('/Sexos/new',{templateUrl:'views/Sexo/detail.html',controller:'NewSexoController'})
      .when('/Sexos/edit/:SexoId',{templateUrl:'views/Sexo/detail.html',controller:'EditSexoController'})
      .when('/Tipoentradas',{templateUrl:'views/Tipoentrada/search.html',controller:'SearchTipoentradaController'})
      .when('/Tipoentradas/new',{templateUrl:'views/Tipoentrada/detail.html',controller:'NewTipoentradaController'})
      .when('/Tipoentradas/edit/:TipoentradaId',{templateUrl:'views/Tipoentrada/detail.html',controller:'EditTipoentradaController'})
