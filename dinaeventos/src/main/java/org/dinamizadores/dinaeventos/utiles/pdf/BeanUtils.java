...
/**
 * Created by Koen Dehaen on 21/05/14.
 *
 * Code base based on http://stackoverflow.com/questions/6133660/recursive-beanutils-describe
 */
public class BeanUtils {
    public static Map<String, String> recursiveDescribe(Object object, String prefix) {
        Set cache = new HashSet();
        return recursiveDescribe(object, prefix, cache);
    }
