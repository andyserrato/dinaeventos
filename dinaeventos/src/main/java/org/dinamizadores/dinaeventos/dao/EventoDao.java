...
public class EventoDao {
	...
	public List<Evento> listAll(Integer startPosition, Integer maxResult) {
		TypedQuery<Evento> findAllQuery = em.createQuery("SELECT DISTINCT e FROM Evento e ORDER BY e.idevento", Evento.class);
	...
	public List<Evento> getEventosByOrganizadorIdThroughUsuarioId(int idUser) {
		...
		TypedQuery<Evento> findEventosByIdOrganizador = em.createQuery("SELECT DISTINCT e FROM Evento e JOIN FETCH e.codigoPostal WHERE e.idorganizador = :idorganizador ORDER BY e.fechaIni DESC", Evento.class);
	...
	public Evento getEventoByName(String name) throws Exception {
		...
		try {
			TypedQuery<Evento> findEventoByName = em.createQuery("SELECT DISTINCT e FROM Evento e JOIN FETCH e.codigoPostal WHERE e.nombre = :name", Evento.class);
