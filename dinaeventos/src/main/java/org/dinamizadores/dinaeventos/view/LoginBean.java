...
//                .callback("http://localhost:8080/dinaeventos/faces/login/login.xhtml")
//                .build(FacebookApi.instance());
////        String logoutUrl = "https://www.facebook.com/logout.php?next=http://localhost:8080/dinaeventos/&access_token=" + accessToken.getAccessToken();
//        String logoutUrl = "https://www.facebook.com/logout.php?next=" + URLEncoder.encode("http://localhost:8080/dinaeventos/faces/login/login.xhtml", "UTF-8") + "&access_token=" + accessToken.getAccessToken();
//
//        ExternalContext externalContext = FacesContext.getCurrentInstance()
//                .getExternalContext();
//
...
//               ex.printStackTrace();
//           }
//        //        final OAuthRequest request = new OAuthRequest(Verb.GET, logoutUrl, service);
////
////
////        
...
//    }
    ...
    public void checkFacebookLogin() {
		...
		/*
		 * Proceso de verificación de login en facebook tanto para primera como para siguientes
		 */
